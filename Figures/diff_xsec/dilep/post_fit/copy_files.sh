...
cp -R  ${trex_path_to_all_fit_vars}/${var}/Plots/SR1_postFit.pdf $current_dir/${var}/Plots/SR1_postFit.pdf
cp -R  ${trex_path_to_all_fit_vars}/${var}/Plots/SR2_postFit.pdf $current_dir/${var}/Plots/SR2_postFit.pdf
#popd
}
## pt
