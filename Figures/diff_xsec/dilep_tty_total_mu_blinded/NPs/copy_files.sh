...
trex_path_to_all_fit_vars="/Users/buddhadeb/Storage/HEP/ttgamma/DiffXSec/Unfolding/xsec-tty-dilep/abs-xsec-with-trexfiles-local/v12/v21/syst-all-fit-data-mu-blinded/"
current_dir=$PWD
