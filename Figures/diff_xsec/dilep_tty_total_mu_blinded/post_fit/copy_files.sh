...
#trex_path_to_all_fit_vars="$HOME/Hep/ttgamma/Unfolding_139fb/xsec-tty-dilep/xsec-tty-dilep/abs-xsec-with-trexfiles-local/v12/v17/backup/syst-all-fit-data-mu-blinded/"
trex_path_to_all_fit_vars="/home/buddha/omni_server/Storage/HEP/ttgamma/DiffXSec/Unfolding/xsec-tty-dilep/abs-xsec-with-trexfiles-local/v12/v25/syst-all-fit-data-mu-blinded/"
current_dir=$PWD
