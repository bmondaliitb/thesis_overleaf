...
trex_path_to_all_fit_vars="/home/buddha/omni_server/Storage/HEP/ttgamma/DiffXSec/Unfolding/xsec-tty-ljet/scripts/compare_NP_pulls_tty_total/compare_ljet_fits/"
current_dir=$PWD
