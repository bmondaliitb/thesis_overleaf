...
trex_path_to_all_fit_vars="$HOME/omni_server/Storage/HEP/ttgamma/DiffXSec/Unfolding/xsec-tty-ljet/abs-xsec-with-trexfiles-local/v12/v30/syst-all/"
current_dir=$PWD

function copy_files {
var=$1
#pushd $trex_path_to_all_fit_vars
cp -R  $trex_path_to_all_fit_vars/${var}/Ranking*.pdf $current_dir/
#popd
}
## pt
