...
trex_path_to_all_fit_vars="$HOME/omni_server/Storage/HEP/ttgamma/DiffXSec/Unfolding/xsec-tty-ljet/scripts/compare_NP_pulls_tty_total/compare_ljet_fits_asimov/"
current_dir=$PWD
