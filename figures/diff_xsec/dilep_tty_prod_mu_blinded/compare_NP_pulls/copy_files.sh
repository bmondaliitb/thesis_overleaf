...
#cp /home/buddha/omni_server/Storage/HEP/ttgamma/DiffXSec/Unfolding/xsec-tty-dilep/abs-xsec-with-trexfiles-local/v12/v24/syst-all-fit-data-mu-blinded/tty2l_pt_all_syst/NuisPar*.pdf tty2l_pt_all_syst/
#cp /home/buddha/omni_server/Storage/HEP/ttgamma/DiffXSec/Unfolding/xsec-tty-dilep/abs-xsec-with-trexfiles-local/v12/v24/syst-all-fit-data-mu-blinded/tty2l_pt_all_syst/CorrMatrix.pdf tty2l_pt_all_syst/
...
trex_path_to_all_fit_vars="$HOME/omni_server/Storage/HEP/ttgamma/DiffXSec/Unfolding/xsec-tty-dilep/scripts/compare_NP_pulls_tty_prod/compare_dilep_fits/"
current_dir=$PWD
