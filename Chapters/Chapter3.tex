...
\begin{figure}[ht]
  \centering
  \subfloat[Part 1]{\includegraphics[width=0.35\textwidth, viewport=0 400 130 800, clip]{figures/diff_xsec/dilep_tty_prod_mu_blinded/compare_NP_pulls/compare_NP_dilep_fits_pt_ptj1_ptll/NuisPar_comp.pdf}}
  \quad 
  \subfloat[Part 2]{\includegraphics[width=0.35\textwidth, viewport=0 0 130 400, clip]{figures/diff_xsec/dilep_tty_prod_mu_blinded/compare_NP_pulls/compare_NP_dilep_fits_pt_ptj1_ptll/NuisPar_comp.pdf}}
  \vspace{0.5cm}
  \label{fig:split_pdf}
\end{figure}
